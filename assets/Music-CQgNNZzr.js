const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-BPqnv1iy.js","assets/index-C3yNwPiv.js","assets/index-DF3BsR2E.css","assets/WidgetMoreDiscoveries-p7bhW19A.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, w as watch, o as onMounted, m as renderList, af as resolveDynamicComponent, ag as defineAsyncComponent, ah as markRaw, ai as __vitePreload, aj as onActivated, ak as onDeactivated } from './index-C3yNwPiv.js';
import { _ as _sfc_main$9 } from './Artists-CIgs5jIT.js';
import { _ as _sfc_main$a } from './Tracks-DA86bHp5.js';
import { _ as _sfc_main$b } from './Releases-qf1FlZv6.js';
import { _ as _sfc_main$c } from './Playlists-DliJke6x.js';
import { B as Block } from './Block-BGScWOuP.js';
import { T as TitleWithButtons } from './TitleWithButtons-agM5Gj3v.js';
import { M as Menu } from './Menu-CNPZ67US.js';
import { _ as _sfc_main$d } from './Ready-qlXZGRsT.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-BPqnv1iy.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-CQgNNZzr.js.map
