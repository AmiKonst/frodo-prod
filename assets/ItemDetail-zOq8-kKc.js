import { _ as _export_sfc, s as stores, r as reactive, i as ref, k as computed, l as onMounted, g as onBeforeUnmount, c as createElementBlock, o as openBlock, v as createBaseVNode, p as renderSlot, n as normalizeStyle, b as createBlock, d as createCommentVNode, y as normalizeClass, h as unref, I as IconButton } from './index-DrZMFpA3.js';
        ...
        createBaseVNode("div", {
          ...
          (props.more)
            ? (openBlock(), createBlock(IconButton, {
                key: 0,
                icon: "settings",
                class: normalizeClass(["tertiary size-l more-button", { invert: unref(others).theme !== 'dark' }]),
                onClick: _cache[0] || (_cache[0] = $event => (emit('more')))
              }, null, 8, ["class"]))
...
const ItemDetail = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-87152a8c"]]);

export { ItemDetail as I };
//# sourceMappingURL=ItemDetail-zOq8-kKc.js.map
