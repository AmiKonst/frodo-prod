import { _ as _export_sfc, s as stores, l as computed, h as ref, o as onMounted, Z as nextTick, a as onBeforeUnmount, k as watch, c as createElementBlock, f as openBlock, y as createBaseVNode, C as withModifiers, p as normalizeClass, u as useI18n, r as reactive, g as api, v as resolveComponent, b as createBlock, w as withCtx, d as createCommentVNode, e as createVNode, I as IconButton, A as AudioToggle, i as unref, x as toDisplayString, F as Fragment, n as renderList, q as Img, L as BaseModal, t as message } from './index-BoU5CK3p.js';
...
const TrackWave = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-93f58932"]]);
...
const seek = async (position) => {
    if (state.value !== 'playing' && state.value !== 'stopped') {
        await play();
        setTimeout(() => {
    ...
    content: withCtx(() => [
      createBaseVNode("ul", _hoisted_2, [
        ...
        (contributors.value?.length)
          ? (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(contributors.value, (item) => {
              return (openBlock(), createElementBlock("li", {
                key: item.id,
                class: "clickable",
...
const ModalTrackKebab = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-93dd2124"]]);

export { ModalTrackKebab as default };
//# sourceMappingURL=ModalTrackKebab-DYvp-JxQ.js.map
