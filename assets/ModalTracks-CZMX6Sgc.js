...
//         if (player.panes.default._item?.id) {
//             return [player.panes.default._item];
//         }
...
const onSortEnd = async (evt) => {
    ...
    // const movedItem = queue.items.splice(evt.oldIndex, 1)[0];
    // queue.items.splice(evt.newIndex, 0, movedItem);
...
const ModalTracks = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-e60bc230"]]);

export { ModalTracks as default };
//# sourceMappingURL=ModalTracks-CZMX6Sgc.js.map
