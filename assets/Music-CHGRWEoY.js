const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-Q94-WuBE.js","assets/index-G3sgYwhJ.js","assets/index-BJVCAjPO.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, t as resolveComponent, l as createBaseVNode, n as normalizeClass, p as Img, e as createVNode, C as withModifiers, I as IconButton, A as AudioToggle, $ as State, v as toDisplayString, h as unref, x as ref, k as withCtx, O as mergeProps, m as renderList, w as watch, o as onMounted, am as resolveDynamicComponent, ab as defineAsyncComponent, an as markRaw, ac as __vitePreload, ao as onActivated, ap as onDeactivated } from './index-G3sgYwhJ.js';
import { _ as _sfc_main$d } from './Artists-sjKUYBLg.js';
import { _ as _sfc_main$e } from './Tracks-o_CzQb8o.js';
import { _ as _sfc_main$f } from './Releases-Bchobeut.js';
import { B as Block } from './Block-BXWyEDIN.js';
/* empty css                                                                         */
import { T as TitleWithButtons } from './TitleWithButtons-9zLErVaA.js';
import { _ as _sfc_main$g } from './Ready-BoQnI48I.js';
import './Collage-nlN12-2P.js';
import './EmptyLabel-BQCha-Wa.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-Q94-WuBE.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-CHGRWEoY.js.map
