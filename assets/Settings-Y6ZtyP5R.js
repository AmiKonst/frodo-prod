const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-BnVfDRPx.js","assets/index-DJgDPUSd.js","assets/index-C9xDhw5v.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-BbSBraok.js","assets/Field-08xLTEiX.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, t as resolveComponent, c as createElementBlock, f as openBlock, l as createBaseVNode, e as createVNode, v as toDisplayString, h as unref, n as normalizeClass, a2 as createStaticVNode, x as ref, r as reactive, j as computed, b as createBlock, d as createCommentVNode, I as IconButton, C as withModifiers, z as normalizeStyle, P as createTextVNode, B as Button, q as message, p as Img, a3 as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, a4 as Toggler, F as Fragment, a5 as __vitePreload } from './index-DJgDPUSd.js';
import { _ as _sfc_main$7 } from './Ready-Bz1WJvsj.js';
import { _ as _sfc_main$6 } from './Select-BOtsUQD7.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-BnVfDRPx.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-BbSBraok.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-Y6ZtyP5R.js.map
