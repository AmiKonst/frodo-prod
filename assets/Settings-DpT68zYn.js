const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-Db-p4d5Y.js","assets/index-C2_PupvE.js","assets/index-BXYJj8hZ.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-BUUd1nzA.js","assets/Field-BEkcVoto.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, z as resolveComponent, c as createElementBlock, o as openBlock, v as createBaseVNode, e as createVNode, x as toDisplayString, h as unref, y as normalizeClass, R as createStaticVNode, i as ref, r as reactive, k as computed, b as createBlock, I as IconButton, A as withModifiers, n as normalizeStyle, d as createCommentVNode, L as createTextVNode, B as Button, K as message, S as defineAsyncComponent, l as onMounted, g as onBeforeUnmount, T as Toggler, F as Fragment, U as __vitePreload } from './index-C2_PupvE.js';
import { _ as _sfc_main$7 } from './Ready-BN08cIEQ.js';
import { I as Img } from './Img-iGgwcdKe.js';
import { _ as _sfc_main$6 } from './Select-SUHpI8Nz.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-Db-p4d5Y.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-BUUd1nzA.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
const Settings = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-1969c85a"]]);

export { Settings as default };
//# sourceMappingURL=Settings-DpT68zYn.js.map
