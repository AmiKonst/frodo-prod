import { _ as _export_sfc, s as stores, u as useI18n, c as createElementBlock, o as openBlock, d as createCommentVNode, x as toDisplayString, h as unref, F as Fragment, m as renderList, b as createBlock, B as Button, y as resolveComponent, v as createBaseVNode, A as withModifiers, z as normalizeClass, G as createTextVNode, k as computed, r as reactive, a as api, e as createVNode, I as IconButton, a8 as hooks, l as onMounted, t as withCtx, g as onBeforeUnmount } from './index-XylrLMAf.js';
import { _ as _sfc_main$9 } from './Ready-DR8BhRpa.js';
import { I as Img } from './Img-CwdGnChE.js';
import { I as ItemDetail } from './ItemDetail-Do1TId53.js';
import { E as EmptyLabel } from './EmptyLabel-BwCIeu5K.js';
import { S as State } from './State-smBLiAl3.js';
import { S as Slider } from './Slider-f9Px9k22.js';
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("label", _hoisted_1$7, [
    (props.title)
      ? (openBlock(), createElementBlock("span", _hoisted_2$6, toDisplayString(unref(t)(props.title)), 1))
...
const TitleWithButtons = /*#__PURE__*/_export_sfc(_sfc_main$8, [['__scopeId',"data-v-9320959f"]]);
...
const AudioToggle = /*#__PURE__*/_export_sfc(_sfc_main$7, [['__scopeId',"data-v-28c266c3"]]);
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(primaryArtists.value, (item, id) => {
      return (openBlock(), createElementBlock(Fragment, { key: id }, [
        (item.id)
          ...
          : (openBlock(), createElementBlock("span", _hoisted_2$5, toDisplayString(`${item.name}${ id < primaryArtists.value.length - 1 ? ',' : ''}`), 1))
      ], 64))
    }), 128)),
    ...
    createBaseVNode("div", null, [
      createBaseVNode("div", null, [
        ...
        (props.item?.fromProject)
          ? (openBlock(), createElementBlock("span", _hoisted_2$4, toDisplayString(unref(t)('releases.from')) + " " + toDisplayString(props.item?.fromProject), 1))
          : createCommentVNode("", true),
        (props.row && props.showState && props.item?.state)
          ? (openBlock(), createBlock(State, {
              key: 1,
...
const ReleasePreview = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-e1e7349d"]]);
...
const Releases = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-609e1184"]]);
...
const TrackPreview = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-6edbf95d"]]);
...
const Artist = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-6d1b3b45"]]);

export { Artist as default };
//# sourceMappingURL=Artist-zOz60vkN.js.map
