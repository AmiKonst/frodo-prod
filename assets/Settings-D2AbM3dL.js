const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-BdeCiMgL.js","assets/index-C0MwdcC7.js","assets/index-C9xDhw5v.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-s6s8N9a-.js","assets/Field-B7kLl_n8.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, t as resolveComponent, c as createElementBlock, f as openBlock, l as createBaseVNode, e as createVNode, v as toDisplayString, h as unref, n as normalizeClass, a2 as createStaticVNode, x as ref, r as reactive, j as computed, b as createBlock, d as createCommentVNode, I as IconButton, C as withModifiers, z as normalizeStyle, P as createTextVNode, B as Button, q as message, p as Img, a3 as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, a4 as Toggler, F as Fragment, a5 as __vitePreload } from './index-C0MwdcC7.js';
import { _ as _sfc_main$7 } from './Ready-Dhp0qG4o.js';
import { _ as _sfc_main$6 } from './Select-BZY54Xrd.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-BdeCiMgL.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-s6s8N9a-.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-D2AbM3dL.js.map
