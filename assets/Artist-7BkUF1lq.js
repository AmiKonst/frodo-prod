import { _ as _export_sfc, s as stores, u as useI18n, c as createElementBlock, d as createCommentVNode, o as openBlock, b as createBlock, z as createBaseVNode, e as createVNode, t as toDisplayString, h as unref, B as Button, r as reactive, f as onMounted, g as onBeforeUnmount, v as withCtx, F as Fragment, R as hooks, I as IconButton, x as normalizeClass, y as message, a as api } from './index-55u5af1X.js';
import { _ as _sfc_main$2 } from './Ready-LQ5I-Wue.js';
import { I as Img } from './Img-DmxZdW6U.js';
import { I as ItemDetail } from './TrackPreview.vue_vue_type_style_index_0_scoped_0fe5f002_lang-Ba4NFHFu.js';
import { a as _sfc_main$3, _ as _sfc_main$4 } from './Tracks--D_S4W4e.js';
import './State-r2MSbgIK.js';
import './TitleWithButtons-CEe7pyvw.js';
/* empty css                                                                          */
import './Slider-Z_65v51s.js';
/* empty css                                                                */
import './EmptyLabel-C4ctX9nV.js';
/* empty css                                                                    */
/* empty css                                                               */
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const qq = () => {
        ...
        async function requestWakeLock() {
          try {
            ...
            console.error('Wake lock failed:', err.name, err.message);  // Fallback: if denied
          }
        }

        // Вызвать при start playback
        requestWakeLock();

        // Release на pause/stop или deactivated
    ...
    onMounted(async () => {
        ...
        setInterval(() => {
          fetch('/keepalive', { method: 'HEAD', cache: 'no-store' });  // Пустой ping
        }, 5000);  // Каждые 5 сек
    });
...
const Artist = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-b8ce2ab9"]]);

export { Artist as default };
//# sourceMappingURL=Artist-7BkUF1lq.js.map
