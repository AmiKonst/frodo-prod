const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-fRk62_-S.js","assets/index-DfObEICq.js","assets/index-k7HnZbql.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, m as renderList, w as watch, o as onMounted, aq as resolveDynamicComponent, af as defineAsyncComponent, ar as markRaw, ag as __vitePreload, as as onActivated, at as onDeactivated } from './index-DfObEICq.js';
import { _ as _sfc_main$b } from './Artists-azVNOBhY.js';
import { _ as _sfc_main$c } from './Tracks-3bmg_drK.js';
import { _ as _sfc_main$d } from './Releases-DfIyhwq0.js';
import { _ as _sfc_main$e } from './Playlists-C6bA5eCP.js';
import { B as Block } from './Block-BLoy9egV.js';
import { T as TitleWithButtons } from './TitleWithButtons-WTBhuDtc.js';
import { _ as _sfc_main$f } from './Ready-B6obmT0C.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-fRk62_-S.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-Bcd_ipbc.js.map
