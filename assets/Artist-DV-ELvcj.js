import { _ as _export_sfc, y as resolveComponent, c as createElementBlock, o as openBlock, v as createBaseVNode, b as createBlock, d as createCommentVNode, A as withModifiers, z as normalizeClass, u as useI18n, F as Fragment, L as createTextVNode, x as toDisplayString, h as unref, k as computed, m as renderList, B as Button, s as stores, r as reactive, a as api, e as createVNode, I as IconButton, ab as hooks, l as onMounted, t as withCtx, g as onBeforeUnmount, K as message } from './index-c4p9dCJN.js';
import { _ as _sfc_main$8 } from './Ready-0XFrmccT.js';
import { I as Img } from './Img-DxUaBxPv.js';
import { I as ItemDetail } from './ItemDetail-Bs00R8xj.js';
import { E as EmptyLabel } from './EmptyLabel-BrDSMycs.js';
import { T as TitleWithButtons } from './TitleWithButtons-BCbGaT5r.js';
import { S as State } from './State-DbvaE7kh.js';
import { S as Slider } from './Slider-DmiW4vQu.js';
      ...
      ? (openBlock(), createBlock(ItemDetail, {
          ...
          toolbar: withCtx(() => [
            createVNode(IconButton, {
              ...
              onClick: _cache[0] || (_cache[0] = $event => (unref(message).info(unref(t)('common.soon'))))
            }, null, 8, ["class"]),
            createVNode(IconButton, {
              icon: "apps",
...
const Artist = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-c3a67922"]]);

export { Artist as default };
//# sourceMappingURL=Artist-DV-ELvcj.js.map
