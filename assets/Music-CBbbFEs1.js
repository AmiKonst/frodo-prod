const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-C8ZhDb2r.js","assets/index-DCNJa9Wi.js","assets/index-vTRAT8b8.css","assets/WidgetMoreDiscoveries-CrQW_gQP.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, l as computed, r as reactive, g as api, x as resolveComponent, n as createBaseVNode, q as normalizeClass, t as Img, e as createVNode, C as withModifiers, I as IconButton, A as AudioToggle, X as State, y as toDisplayString, i as unref, h as ref, w as withCtx, m as mergeProps, k as watch, o as onMounted, p as renderList, ac as resolveDynamicComponent, a3 as defineAsyncComponent, ad as markRaw, a5 as __vitePreload, ae as onActivated, af as onDeactivated } from './index-DCNJa9Wi.js';
import { _ as _sfc_main$a } from './Artists-CtnIkrgH.js';
import { _ as _sfc_main$b } from './Tracks-BbMNApP-.js';
import { _ as _sfc_main$c } from './Releases-BYZQIXf-.js';
import { B as Block } from './Block-BGhJBXdh.js';
/* empty css                                                                         */
import { _ as _sfc_main$d } from './Ready-DvXVXCcW.js';
import './TitleWithButtons-7qGpAfHv.js';
import './EmptyLabel-BWkra0Re.js';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-C8ZhDb2r.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-CBbbFEs1.js.map
