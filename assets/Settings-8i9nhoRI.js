const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-DyPUJllm.js","assets/index-CkEpzWh_.js","assets/index-BXYJj8hZ.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-C20l5fXi.js","assets/Field-DIVJlg-f.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, y as resolveComponent, c as createElementBlock, o as openBlock, v as createBaseVNode, e as createVNode, x as toDisplayString, h as unref, z as normalizeClass, R as createStaticVNode, i as ref, r as reactive, k as computed, b as createBlock, I as IconButton, A as withModifiers, n as normalizeStyle, d as createCommentVNode, L as createTextVNode, B as Button, K as message, S as defineAsyncComponent, l as onMounted, g as onBeforeUnmount, T as Toggler, F as Fragment, U as __vitePreload } from './index-CkEpzWh_.js';
import { _ as _sfc_main$7 } from './Ready-CHpQlu2I.js';
import { I as Img } from './Img-BsaZiHm1.js';
import { _ as _sfc_main$6 } from './Select-BGoLXEGO.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-DyPUJllm.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-C20l5fXi.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-8i9nhoRI.js.map
