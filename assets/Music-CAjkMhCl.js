const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-EYJ0SUrW.js","assets/index-CB_7iPVf.js","assets/index-D0vBOt7B.css","assets/WidgetMoreDiscoveries-CdT2AMwv.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, t as resolveComponent, l as createBaseVNode, n as normalizeClass, p as Img, e as createVNode, C as withModifiers, I as IconButton, A as AudioToggle, Y as State, v as toDisplayString, h as unref, x as ref, k as withCtx, O as mergeProps, w as watch, o as onMounted, m as renderList, al as resolveDynamicComponent, a3 as defineAsyncComponent, am as markRaw, a5 as __vitePreload, an as onActivated, ao as onDeactivated } from './index-CB_7iPVf.js';
import { _ as _sfc_main$d } from './Artists-BkBLYx0E.js';
import { _ as _sfc_main$e } from './Tracks-DiaOHQz4.js';
import { _ as _sfc_main$f } from './Releases-zSXQQ4lJ.js';
import { B as Block } from './Block-Dws78ujt.js';
/* empty css                                                                         */
import { _ as _sfc_main$g } from './Ready-DOuJl6BB.js';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-EYJ0SUrW.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
    ...
    const openSubWidget = (payload) => {
        console.log('subwidget', payload);
    };
                ...
                : (item.releases?.length)
                  ...
                  : (item.playlists?.length)
                    ...
                    : (openBlock(), createBlock(_sfc_main$4, {
                        ...
                        item: item,
                        sectionId: props.sectionId,
                        onChange: openSubWidget,
                        onOpen: $event => (openWidget(item))
                      }, null, 8, ["item", "sectionId", "onOpen"]))
          ], 64))
        : createCommentVNode("", true),
      (item.type === 'STATIC')
...
//# sourceMappingURL=Music-CAjkMhCl.js.map
