const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-BeSEJHgK.js","assets/index-CC0co4PQ.js","assets/index-k7HnZbql.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, m as renderList, w as watch, o as onMounted, aq as resolveDynamicComponent, af as defineAsyncComponent, ar as markRaw, ag as __vitePreload, as as onActivated, at as onDeactivated } from './index-CC0co4PQ.js';
import { _ as _sfc_main$b } from './Artists-mSPvZPHx.js';
import { _ as _sfc_main$c } from './Tracks-8jdXqyrD.js';
import { _ as _sfc_main$d } from './Releases-Drlcx1jG.js';
import { _ as _sfc_main$e } from './Playlists-gNscClTw.js';
import { B as Block } from './Block-Gb8rAfzG.js';
import { T as TitleWithButtons } from './TitleWithButtons-DzpBEIGd.js';
import { _ as _sfc_main$f } from './Ready-C_Sf_OgO.js';
/* empty css                                                                         */
import './EmptyLabel-Bn04Adl9.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-BeSEJHgK.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-DWANEogI.js.map
