const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-5Ju-ZOCm.js","assets/index-CMlHwxef.js","assets/index-ByHZNt4o.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, p as normalizeClass, q as Img, v as toDisplayString, h as unref, e as createVNode, D as withModifiers, I as IconButton, x as ref, k as withCtx, E as mergeProps, m as renderList, w as watch, o as onMounted, ao as resolveDynamicComponent, ad as defineAsyncComponent, ap as markRaw, ae as __vitePreload, aq as onActivated, ar as onDeactivated } from './index-CMlHwxef.js';
import { _ as _sfc_main$b } from './Artists-C4mJmO6X.js';
import { _ as _sfc_main$c } from './Tracks-BpbTNYC6.js';
import { _ as _sfc_main$d } from './Releases-CAG8Ql_-.js';
import { _ as _sfc_main$e } from './Playlists-6yg2vmyV.js';
import { B as Block } from './Block-DfAzDVTS.js';
import { T as TitleWithButtons } from './TitleWithButtons-IaoKodCk.js';
import { _ as _sfc_main$f } from './Ready-CObLGNJj.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-5Ju-ZOCm.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-DjFeT8Cp.js.map
