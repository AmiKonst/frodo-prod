const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-1NNHOj3n.js","assets/index-MSeQtd-7.js","assets/index-BNTF3rfd.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-CTDlNBsw.js","assets/Field-jF8wuZte.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, B as resolveComponent, c as createElementBlock, f as openBlock, x as createBaseVNode, e as createVNode, v as toDisplayString, i as unref, p as normalizeClass, a1 as createStaticVNode, h as ref, r as reactive, l as computed, b as createBlock, I as IconButton, C as withModifiers, z as normalizeStyle, d as createCommentVNode, X as createTextVNode, H as Button, t as message, q as Img, a2 as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, a3 as Toggler, F as Fragment, a4 as __vitePreload } from './index-MSeQtd-7.js';
import { _ as _sfc_main$7 } from './Ready-For89hL4.js';
import { _ as _sfc_main$6 } from './Select-BNI0NFek.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-1NNHOj3n.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-CTDlNBsw.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-DEGuspSv.js.map
