import { _ as _export_sfc, l as ref, i as computed, c as createElementBlock, o as openBlock, d as createCommentVNode, k as createBaseVNode, x as renderSlot, C as createTextVNode, t as toDisplayString, n as normalizeClass } from './index-Bx6N_rW8.js';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const src = computed(() => {
      return `${props.preview?.indexOf("http") === -1 ? "https://api.bilbomusic.com" : ""}${props.preview}`;
    });
    return (_ctx, _cache) => {
...
const Img = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3645b5bb"]]);

export { Img as I };
//# sourceMappingURL=Img-BccfnL-t.js.map
