const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-DsHP5lxe.js","assets/index-CYRtVo48.js","assets/index-BvKlY2mn.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, p as normalizeClass, q as Img, v as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, x as ref, k as withCtx, D as mergeProps, m as renderList, w as watch, o as onMounted, ap as resolveDynamicComponent, ae as defineAsyncComponent, aq as markRaw, af as __vitePreload, ar as onActivated, as as onDeactivated } from './index-CYRtVo48.js';
import { _ as _sfc_main$b } from './Artists-CxJpAztl.js';
import { _ as _sfc_main$c } from './Tracks-DXZ_gRMv.js';
import { _ as _sfc_main$d } from './Releases-Cwk18h7T.js';
import { _ as _sfc_main$e } from './Playlists-ScRvB86T.js';
import { B as Block } from './Block-C61-PU63.js';
import { T as TitleWithButtons } from './TitleWithButtons-Dx9y8JyM.js';
import { _ as _sfc_main$f } from './Ready-5CEw0uSh.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-DsHP5lxe.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-BcFMcxHw.js.map
