const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-B3S-vUwq.js","assets/index-JcJ57S7t.js","assets/index-ByGWfvsY.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, w as watch, o as onMounted, m as renderList, af as resolveDynamicComponent, ag as defineAsyncComponent, ah as markRaw, ai as __vitePreload, aj as onActivated, ak as onDeactivated } from './index-JcJ57S7t.js';
import { _ as _sfc_main$9 } from './Artists-DJgfx3jd.js';
import { _ as _sfc_main$a } from './Tracks-CM2XlNuM.js';
import { _ as _sfc_main$b } from './Releases-DjGkt0bp.js';
import { _ as _sfc_main$c } from './Playlists-CoDck5EQ.js';
import { B as Block } from './Block-CdVHcFwB.js';
import { T as TitleWithButtons } from './TitleWithButtons-BOU3tO6f.js';
import { M as Menu } from './Menu-Bs7UIUkL.js';
import { _ as _sfc_main$d } from './Ready-moSTnk9v.js';
/* empty css                                                                         */
import './EmptyLabel-C5J4skJW.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-B3S-vUwq.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-BMhgKMlj.js.map
