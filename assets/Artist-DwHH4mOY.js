...
const Releases = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-8d6c597e"]]);
    ...
    (data.ready)
      ? (openBlock(), createBlock(ItemDetail, {
          ...
          toolbar: withCtx(() => [
            createVNode(IconButton, {
              icon: "apps",
              class: normalizeClass(["tertiary size-xl animate-1", { invert: unref(others).theme !== 'dark' }]),
...
const Artist = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a786509b"]]);

export { Artist as default };
//# sourceMappingURL=Artist-DwHH4mOY.js.map
