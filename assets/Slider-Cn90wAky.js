import { _ as _export_sfc, i as ref, s as stores, j as onActivated, k as computed, w as watch, l as onMounted, c as createElementBlock, o as openBlock, F as Fragment, m as renderList, n as normalizeStyle, p as renderSlot, q as nextTick } from './index-WuWwFjaj.js';
...
const colStyle = computed(() => ({
    flex: '0 0 auto',
    scrollSnapAlign: props.colAlign === 'dynamic' ? null : (dynamicColAlign.value === 'auto-direction' ? 'start' : dynamicColAlign.value),
...
const onScroll = () => {
    ...
    if (props.colAlign === 'none' || props.colAlign === 'dynamic') {
        return;
    }
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(visibleCols.value, (col, colIndex) => {
      return (openBlock(), createElementBlock("div", {
        ...
        style: normalizeStyle({
                ...colStyle.value,
                scrollSnapAlign: props.colAlign === 'dynamic' ? (
                    colIndex === 0 ? 'start' : ( colIndex === visibleCols.value?.length - 1 ? 'end' : 'center' )
...
const Slider = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-c580ed0f"]]);

export { Slider as S };
//# sourceMappingURL=Slider-Cn90wAky.js.map
