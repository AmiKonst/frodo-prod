const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-zVk7pMaW.js","assets/index-Tfbpknhu.js","assets/index-ByGWfvsY.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, w as watch, o as onMounted, m as renderList, af as resolveDynamicComponent, ag as defineAsyncComponent, ah as markRaw, ai as __vitePreload, aj as onActivated, ak as onDeactivated } from './index-Tfbpknhu.js';
import { _ as _sfc_main$9 } from './Artists-B1yHxBdL.js';
import { _ as _sfc_main$a } from './Tracks-DrSzBa4u.js';
import { _ as _sfc_main$b } from './Releases-CbrOJwgV.js';
import { _ as _sfc_main$c } from './Playlists-Di0OdYiC.js';
import { B as Block } from './Block-7rB5YDKU.js';
import { T as TitleWithButtons } from './TitleWithButtons-BL3Vct56.js';
import { M as Menu } from './Menu-DklLc40V.js';
import { _ as _sfc_main$d } from './Ready-huZ7n5AL.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-zVk7pMaW.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-DLo8oq2z.js.map
