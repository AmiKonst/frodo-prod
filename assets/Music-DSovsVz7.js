const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-BNwYjNxH.js","assets/index-DWzXmQCg.js","assets/index-BvKlY2mn.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, p as normalizeClass, q as Img, v as toDisplayString, h as unref, e as createVNode, D as withModifiers, I as IconButton, x as ref, k as withCtx, E as mergeProps, m as renderList, w as watch, o as onMounted, ao as resolveDynamicComponent, ad as defineAsyncComponent, ap as markRaw, ae as __vitePreload, aq as onActivated, ar as onDeactivated } from './index-DWzXmQCg.js';
import { _ as _sfc_main$b } from './Artists-CFwb-APk.js';
import { _ as _sfc_main$c } from './Tracks-DqyTdfaR.js';
import { _ as _sfc_main$d } from './Releases-Din3hE2Q.js';
import { _ as _sfc_main$e } from './Playlists-BhppDENB.js';
import { B as Block } from './Block-Cbe8SF6a.js';
import { T as TitleWithButtons } from './TitleWithButtons-DRH87EXY.js';
import { _ as _sfc_main$f } from './Ready-C5K1C5nY.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-BNwYjNxH.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-DSovsVz7.js.map
