const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-6ba4RFVI.js","assets/index-CdYVsIuq.js","assets/index-BgVTGmpb.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-BAsV2bHB.js","assets/Field-SmNGhFch.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, A as resolveComponent, c as createElementBlock, o as openBlock, p as createBaseVNode, e as createVNode, t as toDisplayString, h as unref, n as normalizeClass, V as createStaticVNode, q as ref, r as reactive, j as computed, b as createBlock, I as IconButton, C as withModifiers, x as normalizeStyle, d as createCommentVNode, L as createTextVNode, B as Button, m as message, W as defineAsyncComponent, f as onMounted, g as onBeforeUnmount, X as Toggler, F as Fragment, Y as __vitePreload } from './index-CdYVsIuq.js';
import { _ as _sfc_main$7 } from './Ready-DNk-jMX9.js';
import { I as Img } from './Img-CbNMG4KO.js';
import { _ as _sfc_main$6 } from './Select-D8HHc_DZ.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-6ba4RFVI.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-BAsV2bHB.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-BboK5cRI.js.map
