const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-CkZIJK3s.js","assets/index-DXGHtgMF.js","assets/index-k7HnZbql.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, m as renderList, w as watch, o as onMounted, ao as resolveDynamicComponent, ad as defineAsyncComponent, ap as markRaw, ae as __vitePreload, aq as onActivated, ar as onDeactivated } from './index-DXGHtgMF.js';
import { _ as _sfc_main$b } from './Artists-g55wDJAM.js';
import { _ as _sfc_main$c } from './Tracks-aLUaxTNE.js';
import { _ as _sfc_main$d } from './Releases-BsuCRWDw.js';
import { _ as _sfc_main$e } from './Playlists-ClQvG8Aq.js';
import { B as Block } from './Block-CKldhRir.js';
import { T as TitleWithButtons } from './TitleWithButtons-eKiKSV2P.js';
import { _ as _sfc_main$f } from './Ready-DffzpQPY.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-CkZIJK3s.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-6L6gcjDs.js.map
