const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-5Bj-JPKS.js","assets/index-DUZ8Nute.js","assets/index-C7V_IU1n.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-BgQxavAR.js","assets/Field-DHXGv2GX.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, t as resolveComponent, c as createElementBlock, f as openBlock, l as createBaseVNode, e as createVNode, v as toDisplayString, h as unref, n as normalizeClass, a2 as createStaticVNode, x as ref, r as reactive, j as computed, b as createBlock, d as createCommentVNode, I as IconButton, C as withModifiers, z as normalizeStyle, P as createTextVNode, B as Button, q as message, p as Img, a3 as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, a4 as Toggler, F as Fragment, a5 as __vitePreload } from './index-DUZ8Nute.js';
import { _ as _sfc_main$7 } from './Ready-BL3Dvy5S.js';
import { _ as _sfc_main$6 } from './Select-DahaBwKq.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-5Bj-JPKS.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-BgQxavAR.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-DWWboQis.js.map
