import { _ as _export_sfc, l as ref, i as computed, c as createElementBlock, o as openBlock, d as createCommentVNode, k as createBaseVNode, x as renderSlot, C as createTextVNode, t as toDisplayString, n as normalizeClass } from './index-DnuixuCF.js';
...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const src = computed(() => {
      return `${props.preview?.indexOf("http") === -1 ? "https://api.bilbomusic.io" : ""}${props.preview}`;
    });
    return (_ctx, _cache) => {
...
export { Img as I };
//# sourceMappingURL=Img-GdQOlsWF.js.map
