import { _ as _export_sfc, s as stores, v as ref, o as onMounted, a1 as onUnmounted, w as watch, c as createElementBlock, f as openBlock, u as useI18n, r as reactive, g as api, X as resolveDirective, b as createBlock, k as withCtx, l as createBaseVNode, F as Fragment, m as renderList, n as normalizeClass, e as createVNode, a2 as Icon, E as withDirectives, d as createCommentVNode, y as normalizeStyle, h as unref, B as Button, L as BaseModal } from './index-BZWU9VTZ.js';
import { a as REACTIONS_BY_ENTITY } from './reaction-CFeqrAcC.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      await getItems();
      const result = await api.entity().owner(data.entityType, data.entityId, data.field);
      if (result) {
        try {
          data.values = JSON.parse(result)?.values || [];
        } catch (e) {
        }
      }
      data.loading = false;
...
const ModalSetupReaction = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac49359c"]]);

export { ModalSetupReaction as default };
//# sourceMappingURL=ModalSetupReaction-BngTMFnY.js.map
