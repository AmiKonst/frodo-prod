const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-8wGeyBEe.js","assets/index-BsxOk-dY.js","assets/index-ByGWfvsY.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, w as watch, o as onMounted, m as renderList, af as resolveDynamicComponent, ag as defineAsyncComponent, ah as markRaw, ai as __vitePreload, aj as onActivated, ak as onDeactivated } from './index-BsxOk-dY.js';
import { _ as _sfc_main$9 } from './Artists-B-xAB37R.js';
import { _ as _sfc_main$a } from './Tracks-cPN8vMue.js';
import { _ as _sfc_main$b } from './Releases-Cj3-wtYb.js';
import { _ as _sfc_main$c } from './Playlists-BWfcPhxl.js';
import { B as Block } from './Block-CoXMFzSv.js';
import { T as TitleWithButtons } from './TitleWithButtons-DZnCqyWW.js';
import { M as Menu } from './Menu-BZM9GOXq.js';
import { _ as _sfc_main$d } from './Ready-DFy8Ysb2.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-8wGeyBEe.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-N-eqnhOY.js.map
