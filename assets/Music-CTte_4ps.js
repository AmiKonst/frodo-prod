const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-CGHaapaK.js","assets/index-DNB2u1CE.js","assets/index-BJVCAjPO.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, t as resolveComponent, l as createBaseVNode, n as normalizeClass, p as Img, e as createVNode, C as withModifiers, I as IconButton, A as AudioToggle, $ as State, v as toDisplayString, h as unref, x as ref, k as withCtx, O as mergeProps, m as renderList, w as watch, o as onMounted, am as resolveDynamicComponent, ab as defineAsyncComponent, an as markRaw, ac as __vitePreload, ao as onActivated, ap as onDeactivated } from './index-DNB2u1CE.js';
import { _ as _sfc_main$d } from './Artists-Nk0x5fUN.js';
import { _ as _sfc_main$e } from './Tracks-BB-Bie2X.js';
import { _ as _sfc_main$f } from './Releases-DlwuwCUl.js';
import { B as Block } from './Block-CVi9c7G0.js';
/* empty css                                                                         */
import { T as TitleWithButtons } from './TitleWithButtons--2la0jMc.js';
import { _ as _sfc_main$g } from './Ready-Deqe0KX3.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-CGHaapaK.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-CTte_4ps.js.map
