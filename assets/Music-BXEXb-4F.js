const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-BEi58gUe.js","assets/index-BzMg08Mj.js","assets/index-GaP7_BgA.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, p as normalizeClass, q as Img, v as toDisplayString, h as unref, e as createVNode, D as withModifiers, I as IconButton, x as ref, k as withCtx, E as mergeProps, m as renderList, w as watch, o as onMounted, ao as resolveDynamicComponent, ad as defineAsyncComponent, ap as markRaw, ae as __vitePreload, aq as onActivated, ar as onDeactivated } from './index-BzMg08Mj.js';
import { _ as _sfc_main$b } from './Artists-ChGVpxah.js';
import { _ as _sfc_main$c } from './Tracks-DDffxwLi.js';
import { _ as _sfc_main$d } from './Releases-C2u9hrds.js';
import { _ as _sfc_main$e } from './Playlists-CiYRzbvJ.js';
import { B as Block } from './Block-DnM3pBfR.js';
import { T as TitleWithButtons } from './TitleWithButtons-wwZjJxCU.js';
import { _ as _sfc_main$f } from './Ready-NDFoU1p5.js';
/* empty css                                                                         */
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-BEi58gUe.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-BXEXb-4F.js.map
