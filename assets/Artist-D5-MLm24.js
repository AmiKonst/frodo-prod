import { _ as _export_sfc, s as stores, u as useI18n, c as createElementBlock, d as createCommentVNode, o as openBlock, b as createBlock, p as createBaseVNode, e as createVNode, t as toDisplayString, h as unref, B as Button, r as reactive, f as onMounted, g as onBeforeUnmount, k as withCtx, F as Fragment, K as hooks, I as IconButton, n as normalizeClass, m as message, a as api } from './index-D3R6xFb2.js';
import { _ as _sfc_main$2 } from './Ready-oVjoWnfA.js';
import { I as Img } from './Img-Cg4gaCDd.js';
import { I as ItemDetail } from './ItemDetail-BcecunXf.js';
import { a as _sfc_main$3, _ as _sfc_main$4 } from './Tracks-DnHvKwKF.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const open = () => {
        modals.open('artist', { data: { code: props.artist.code } });
    };
...
const ArtistPreviewCard = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-7b8c8222"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const openKebab = () => {
        modals.open('artist-kebab', { data: { code: props.code } });
    };
    ...
    const openArtist = () => {
        modals.open('artist', { data: { code: props.code } });
    };
...
const Artist = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-14edc0ee"]]);

export { Artist as default };
//# sourceMappingURL=Artist-D5-MLm24.js.map
