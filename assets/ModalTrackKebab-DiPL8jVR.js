import { _ as _export_sfc, u as useI18n, s as stores, g as api, r as reactive, j as computed, o as onMounted, q as resolveComponent, b as createBlock, f as openBlock, k as withCtx, l as createBaseVNode, c as createElementBlock, d as createCommentVNode, e as createVNode, I as IconButton, A as AudioToggle, n as normalizeClass, h as unref, R as Reaction, W as TrackWave, t as toDisplayString, F as Fragment, m as renderList, p as Img, L as BaseModal, N as message } from './index-Dqo5_KXp.js';
import { T as TRACK_REACTIONS } from './reaction-BpWSoPWU.js';
...
const setupReactions = () => {
    modals.open('options', {
        quietClose: true,
        data: {
            title: t('modals.track-kebab.setup-reactions'),
            options: TRACK_REACTIONS.map(item => ({
                ...item,
                name: t(item.name)
            }))
        },
...
onMounted(async () => {
    ...
    if (payload.item) {
        ...
        data.item = await tracks.get(payload.id);
    }
    ...
    content: withCtx(() => [
      createBaseVNode("ul", _hoisted_2, [
        ...
        (contributors.value?.length)
          ...
          : createCommentVNode("", true),
        (data.item?.id && unref(tracks).canEditOwnerSettings({ track: data.item }))
          ? (openBlock(), createElementBlock("li", {
              key: 8,
              class: "clickable",
              ...
              createBaseVNode("span", null, toDisplayString(unref(t)('modals.track-kebab.setup-reactions')), 1)
            ]))
          : createCommentVNode("", true)
      ])
    ]),
...
const ModalTrackKebab = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-f7221be0"]]);

export { ModalTrackKebab as default };
//# sourceMappingURL=ModalTrackKebab-DiPL8jVR.js.map
