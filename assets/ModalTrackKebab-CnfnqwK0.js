...
onMounted(async () => {
    ...
    if (player.panes?.default?._pult && player.panes?.default?._pult?.id === data.item?.id) {
...
const ModalTrackKebab = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-c45aeef9"]]);

export { ModalTrackKebab as default };
//# sourceMappingURL=ModalTrackKebab-CnfnqwK0.js.map
