import { a8 as getDefaultExportFromCjs, _ as _export_sfc, u as useI18n, s as stores, j as onMounted, b as createBlock, o as openBlock, p as withCtx, k as createBaseVNode, h as unref, e as createVNode, I as IconButton, G as BaseModal, a9 as copyText, L as message } from './index-Cv0GIXlT.js';
...
const copy = () => {
    ...
    copyText(`https://t.me/bilboMusicBot/app?startapp=ref_${user?.profile?.id}`);
    message.success(t('modals.invite.copied'));
};

const share = () => {
    if (window.Telegram?.WebApp) {
        const external_url = `https://telegram.me/share/url?url=https://t.me/bilboMusicBot/app?startapp=ref_${
            user?.profile?.id
        }&text=${t('modals.invite.message')}`;
...
const createQr = () => {
    ...
    QRCode.toCanvas(canvas, `https://t.me/bilboMusicBot/app?startapp=ref_${user?.profile?.id}`, {
        color: {
            dark: '#101010',
            light: '#ffffff'
        },
      ...
      createBaseVNode("div", _hoisted_3, [
        ...
        createBaseVNode("div", _hoisted_4, [
          createVNode(IconButton, {
            title: unref(t)('modals.invite.share'),
            class: "invert secondary size-l",
            icon: "share",
            onClick: share
          }, null, 8, ["title"]),
          createVNode(IconButton, {
            title: unref(t)('modals.invite.copy'),
            class: "invert secondary size-l",
            icon: "copy",
            onClick: copy
          }, null, 8, ["title"])
...
const ModalInvite = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-c0e6137b"]]);

export { ModalInvite as default };
//# sourceMappingURL=ModalInvite-D4E73iVL.js.map
