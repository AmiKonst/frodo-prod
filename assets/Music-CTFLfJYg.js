const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-BcsznHIZ.js","assets/index-BPEF5rNU.js","assets/index-D-so8P2m.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, t as resolveComponent, l as createBaseVNode, n as normalizeClass, p as Img, e as createVNode, C as withModifiers, I as IconButton, A as AudioToggle, Y as State, v as toDisplayString, h as unref, x as ref, k as withCtx, O as mergeProps, m as renderList, w as watch, o as onMounted, al as resolveDynamicComponent, a3 as defineAsyncComponent, am as markRaw, a5 as __vitePreload, an as onActivated, ao as onDeactivated } from './index-BPEF5rNU.js';
import { _ as _sfc_main$d } from './Artists-BTMBGyUf.js';
import { _ as _sfc_main$e } from './Tracks-BuJ5gK5L.js';
import { _ as _sfc_main$f } from './Releases-s1po0SqI.js';
import { B as Block } from './Block-Dsyn7YuC.js';
/* empty css                                                                         */
import { T as TitleWithButtons } from './TitleWithButtons-buZDzghq.js';
import { _ as _sfc_main$g } from './Ready-jTI00tdO.js';
import './Collage-DJHdphLX.js';
import './EmptyLabel-CrWiLqKz.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-BcsznHIZ.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-CTFLfJYg.js.map
