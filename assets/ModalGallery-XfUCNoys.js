import { _ as _export_sfc, s as stores, r as reactive, o as onMounted, a as onBeforeUnmount, X as resolveDirective, b as createBlock, f as openBlock, k as withCtx, l as createBaseVNode, E as withDirectives, c as createElementBlock, y as normalizeStyle, F as Fragment, m as renderList, C as withModifiers, n as normalizeClass, d as createCommentVNode, e as createVNode, Y as Loader, Z as Transition, h as unref, G as vShow, L as BaseModal } from './index-CHQd6tYQ.js';
                    ...
                    createVNode(Transition, { name: "fade" }, {
                      default: withCtx(() => [
                        withDirectives(createBaseVNode("img", {
                          src: (img.original || img.resized).indexOf("http") === 0 ? img.original || img.resized : `${unref(BASE_URL)}${img.original || img.resized}`,
...
const ModalGallery = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-06b95ad0"]]);

export { ModalGallery as default };
//# sourceMappingURL=ModalGallery-XfUCNoys.js.map
