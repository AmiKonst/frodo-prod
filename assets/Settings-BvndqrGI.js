const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalEditFirstName-DjVfnguS.js","assets/index-CGxb6vj5.js","assets/index-D8Onrwoq.css","assets/Field-Cn7GlOjm.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, q as resolveComponent, c as createElementBlock, f as openBlock, d as createCommentVNode, l as createBaseVNode, h as unref, n as normalizeClass, e as createVNode, t as toDisplayString, ac as createStaticVNode, v as ref, r as reactive, j as computed, b as createBlock, I as IconButton, C as withModifiers, y as normalizeStyle, T as createTextVNode, B as Button, N as message, g as api, p as Img, F as Fragment, m as renderList, ag as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, ad as Toggler, a0 as delay, ai as __vitePreload } from './index-CGxb6vj5.js';
import { _ as _sfc_main$8 } from './Ready-B_a5e_gO.js';
import { _ as _sfc_main$7 } from './Select-BA-gOnom.js';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const defaultUserImage = computed(() => {
        return api.users().defaultUserImage;
    });
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", _hoisted_1$2, [
    createBaseVNode("div", {
      ...
      (unref(user)?.profile?.profileImage?.resized || defaultUserImage.value.resized)
        ? (openBlock(), createBlock(Img, {
            key: 0,
            preview: unref(user)?.profile?.profileImage?.resized || defaultUserImage.value.resized,
            original: unref(user)?.profile?.profileImage?.original || defaultUserImage.value.original,
...
const Profile = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-b8728d25"]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-DjVfnguS.js'),true              ?__vite__mapDeps([0,1,2,3,4,5]):void 0))
    });
...
//# sourceMappingURL=Settings-BvndqrGI.js.map
