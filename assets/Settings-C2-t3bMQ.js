const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-Dre-hTL1.js","assets/index-DSoYMPKE.js","assets/index-D6f7nAU_.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-CKy_qsiK.js","assets/Field-CvoYaZIz.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, x as resolveComponent, c as createElementBlock, f as openBlock, n as createBaseVNode, e as createVNode, y as toDisplayString, i as unref, q as normalizeClass, a2 as createStaticVNode, h as ref, r as reactive, l as computed, b as createBlock, I as IconButton, C as withModifiers, B as normalizeStyle, d as createCommentVNode, Y as createTextVNode, H as Button, v as message, t as Img, a3 as defineAsyncComponent, o as onMounted, a as onBeforeUnmount, a4 as Toggler, F as Fragment, a5 as __vitePreload } from './index-DSoYMPKE.js';
import { _ as _sfc_main$7 } from './Ready-I_oEQTer.js';
import { _ as _sfc_main$6 } from './Select-DjPxMCyu.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-Dre-hTL1.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-CKy_qsiK.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-C2-t3bMQ.js.map
