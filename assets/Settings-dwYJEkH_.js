const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-CYsRkgvO.js","assets/index-BTMnNZXM.js","assets/index-Bq_bXqDC.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-DIyTZsSE.js","assets/Field-Df4GI8e4.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, v as resolveComponent, c as createElementBlock, o as openBlock, p as createBaseVNode, e as createVNode, t as toDisplayString, h as unref, n as normalizeClass, W as createStaticVNode, q as ref, r as reactive, j as computed, b as createBlock, I as IconButton, x as withModifiers, J as normalizeStyle, d as createCommentVNode, L as createTextVNode, C as Button, m as message, X as defineAsyncComponent, f as onMounted, g as onBeforeUnmount, Y as Toggler, F as Fragment, Z as __vitePreload } from './index-BTMnNZXM.js';
import { _ as _sfc_main$7 } from './Ready-BlAkbd9s.js';
import { I as Img } from './Img-B-w7ijwj.js';
import { _ as _sfc_main$6 } from './Select-vw4L6wYe.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-CYsRkgvO.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-DIyTZsSE.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-dwYJEkH_.js.map
