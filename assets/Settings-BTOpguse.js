const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ModalStudioAuth-CHymKSgV.js","assets/index-XylrLMAf.js","assets/index-DEoABc71.css","assets/ModalStudioAuth-Dlo-MbQy.css","assets/ModalEditFirstName-DZZllcnx.js","assets/Field-CYvO5LWT.js","assets/Field-DxVcON4E.css","assets/ModalEditFirstName-DkVTLprY.css"])))=>i.map(i=>d[i]);
import { _ as _export_sfc, u as useI18n, s as stores, c as createElementBlock, o as openBlock, v as createBaseVNode, e as createVNode, y as resolveComponent, x as toDisplayString, h as unref, z as normalizeClass, P as createStaticVNode, i as ref, r as reactive, k as computed, b as createBlock, I as IconButton, A as withModifiers, n as normalizeStyle, d as createCommentVNode, G as createTextVNode, B as Button, N as message, Q as defineAsyncComponent, l as onMounted, g as onBeforeUnmount, T as Toggler, F as Fragment, R as __vitePreload } from './index-XylrLMAf.js';
import { _ as _sfc_main$7 } from './Ready-DR8BhRpa.js';
import { I as Img } from './Img-CwdGnChE.js';
import { _ as _sfc_main$6 } from './Select-CujiFtBi.js';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    modals.register({
        'studio-auth': defineAsyncComponent(() => __vitePreload(() => import('./ModalStudioAuth-CHymKSgV.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0)),
        'edit-firstname': defineAsyncComponent(() => __vitePreload(() => import('./ModalEditFirstName-DZZllcnx.js'),true              ?__vite__mapDeps([4,1,2,5,6,7]):void 0))
    });
...
//# sourceMappingURL=Settings-BTOpguse.js.map
