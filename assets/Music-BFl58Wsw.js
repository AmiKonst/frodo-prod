const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/WidgetMoreDiscoveries-CcEoHSwx.js","assets/index-CfjYYhy-.js","assets/index-CG0zQC_y.css","assets/WidgetMoreDiscoveries-DTsZXSuE.css"])))=>i.map(i=>d[i]);
import { c as createElementBlock, d as createCommentVNode, f as openBlock, b as createBlock, F as Fragment, _ as _export_sfc, s as stores, u as useI18n, j as computed, r as reactive, g as api, l as createBaseVNode, n as normalizeClass, p as Img, t as toDisplayString, h as unref, e as createVNode, C as withModifiers, I as IconButton, v as ref, k as withCtx, D as mergeProps, w as watch, o as onMounted, m as renderList, af as resolveDynamicComponent, ag as defineAsyncComponent, ah as markRaw, ai as __vitePreload, aj as onActivated, ak as onDeactivated } from './index-CfjYYhy-.js';
import { _ as _sfc_main$9 } from './Artists-BuHmlAYn.js';
import { _ as _sfc_main$a } from './Tracks-Bg1hWTdB.js';
import { _ as _sfc_main$b } from './Releases-BHMR6km8.js';
import { _ as _sfc_main$c } from './Playlists-FguVcK15.js';
import { B as Block } from './Block-DuYdobRk.js';
import { T as TitleWithButtons } from './TitleWithButtons-s4VJc3Tb.js';
import { M as Menu } from './Menu-fqoT9QRM.js';
import { _ as _sfc_main$d } from './Ready-B3IuJ_Fp.js';
/* empty css                                                                         */
import './EmptyLabel-CQ9vIEVh.js';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const staticMap = {
        'more-discoveries': async () => defineAsyncComponent(() => __vitePreload(() => import('./WidgetMoreDiscoveries-CcEoHSwx.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0))
    };
...
//# sourceMappingURL=Music-BFl58Wsw.js.map
